...
user='scm11.student'
password='sFS68957'
URL="https://adc2-zgtd-fa-ext.oracledemos.com:443/fscmRestApi/resources/11.13.18.05/ideas?&onlyData=true&limit=29"
...
with open('PythonAssignments\RestExamplesSCM\demofile_limits.json', 'w') as outfile:
